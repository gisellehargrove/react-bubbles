...
A token is used to authenticate a user to a webpage. It is a unique value used to verify if the user is authenticated.
- [ ] What steps can you take in your web apps to keep your data secure?
Hash passwords, don't send usernames and passwords through http requests
- [ ] Describe how web servers work.
Web servers listen for calls made to them. They determine the data to send back based on the type of call and route they are sent through
